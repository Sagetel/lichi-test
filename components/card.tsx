...
interface Props {
    post: Post;
    setNumberPost: React.Dispatch<React.SetStateAction<number>>
}

function Card(props: Props) {
  const { post, setNumberPost } = props;
  return (
       ...
       after:blur after:-bottom-4 max-h-80 overflow-hidden cursor-pointer" onClick={() => { setNumberPost(post.id); }}>
            <header>
